## Modified version of https://github.com/microe/angora-blue/blob/master/cascade_training/describe.py
## Credits goes to the original author Erik Hovland
...
def describePositive():
    ...
    for imagePath in glob.glob('cat_dataset/*.jpg'):
        ...
        if crop is None:
            ...
            continue
        # Save the crop.
        cropPath = imagePath.replace("cat_dataset","cat_dataset_output")
